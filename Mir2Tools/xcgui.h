...
/*@声明
#define  WM_PAINT   //@别名 窗口事件_绘制
#define  WM_CLOSE   //@别名 窗口事件_关闭
#define  WM_DESTROY   //@别名 窗口事件_销毁
#define  WM_NCDESTROY  //@别名 窗口事件_非客户区销毁
#define  WM_MOUSEMOVE  //@别名 窗口事件_鼠标移动
#define  WM_LBUTTONDOWN  //@别名 窗口事件_鼠标左键按下
#define  WM_LBUTTONUP    //@别名 窗口事件_鼠标左键弹起
#define  WM_RBUTTONDOWN  //@别名 窗口事件_鼠标右键按下
#define  WM_RBUTTONUP    //@别名 窗口事件_鼠标右键弹起
#define  WM_LBUTTONDBLCLK  //@别名 窗口事件_鼠标左键双击
#define  WM_RBUTTONDBLCLK  //@别名 窗口事件_鼠标右键双击
#define  WM_MOUSEWHEEL     //@别名 窗口事件_鼠标滚轮滚动
#define  WM_EXITSIZEMOVE   //@别名 窗口事件_退出改变大小或移动
#define  WM_MOUSEHOVER     //@别名 窗口事件_鼠标悬停
#define  WM_MOUSELEAVE     //@别名 窗口事件_鼠标离开
#define  WM_SIZE           //@别名 窗口事件_大小改变
#define  WM_TIMER          //@别名 窗口事件_定时器
#define  WM_SETFOCUS       //@别名 窗口事件_置焦点
#define  WM_KILLFOCUS      //@别名 窗口事件_失去焦点
#define  WM_KEYDOWN        //@别名 窗口事件_键盘按下
#define  WM_CAPTURECHANGED //@别名 窗口事件_鼠标捕获改变
#define  WM_SETCURSOR      //@别名 窗口事件_置光标
#define  WM_CHAR           //@别名 窗口事件_字符输入
#define  WM_DROPFILES      //@别名 窗口事件_文件拖入
...
#define  XWM_WINDPROC         0x7000+2   //@别名 窗口事件_过程  //注册窗口处理过程
...
#define  XWM_XC_TIMER         0x7000+5 //@别名 窗口事件_炫彩定时器   //wParam:定时器ID, lParam:0
...
#define  XWM_MENU_DRAW_BACKGROUND   0x7000+15 //@别名 窗口事件_菜单背景绘制  //绘制菜单背景
...
#define  XWM_MENU_DRAWITEM             0x7000+16  //@别名 窗口事件_菜单项绘制 //绘制菜单项 
...
#define  XWM_PAINT_END               0x7000+19  //@别名 窗口事件_绘制完成

///@brief 窗口绘制完成并且已经显示到屏幕
///@code   int CALLBACK OnWndDrawWindowDisplay(BOOL *pbHandled) @endcode
#define  XWM_PAINT_DISPLAY           0x7000+20   //@别名 窗口事件_绘制完成显示
...
#define  XWM_DOCK_POPUP              0x7000+21    //@别名 窗口事件_框架窗口码头弹出窗格
...
#define  XWM_FLOATWND_DRAG           0x7000+22   //@别名 窗口事件_浮动窗口拖动

///@brief  窗格显示隐藏
///@code int CALLBACK OnWndPaneShow(HELE hPane, BOOL bShow, BOOL *pbHandled); @endcode
#define  XWM_PANE_SHOW              0x7000+23   //@别名 窗口事件_窗格显示
...
#define  XWM_BODYVIEW_RECT          0x7000+24   //@别名 窗口事件_主视图坐标改变
///@}
...
#define  XE_ELEPROCE         1     //@别名  元素事件_过程

/// @brief 元素绘制事件
/// @code  int CALLBACK OnDraw(HDRAW hDraw,BOOL *pbHandled)  @endcode
#define  XE_PAINT            2  //@别名  元素事件_绘制
...
/// @param hEle        元素句柄.
/// @param nTimerID    定时器ID.
#define  XE_XC_TIMER             16 //@别名  元素事件_炫彩定时器  //wParam:定时器ID, lParam:0
...
#define  XE_LISTBOX_TEMP_CREATE     81  //@别名  元素事件_列表框模板创建
...
#define  XE_LISTBOX_TEMP_CREATE_END     82  //@别名  元素事件_列表框模板创建完成
...
#define  XE_LISTBOX_TEMP_DESTROY    83  //@别名  元素事件_列表框模板销毁
...
#define  XE_LISTBOX_DRAWITEM     85 //@别名  元素事件_列表框项绘制

/// @brief 列表框元素,项选择事件.
/// @code  int CALLBACK OnListBoxSelect(int iItem,BOOL *pbHandled)  @endcode
#define  XE_LISTBOX_SELECT       86   //@别名  元素事件_列表框项选择
...
/// @param nFlag  0:状态改变; 1:新模板实例; 2:旧模板复用 
#define  XE_LIST_TEMP_CREATE     101  //@别名  元素事件_列表模板创建
...
/// @param nFlag  0:状态改变(复用); 1:新模板实例; 2:旧模板复用
#define  XE_LIST_TEMP_CREATE_END     102  //@别名  元素事件_列表模板创建完成
...
/// @param  nFlag   0:正常销毁;  1:移动到缓存(不会被销毁,临时缓存备用,当需要时被复用)
#define  XE_LIST_TEMP_DESTROY    103  //@别名  元素事件_列表模板销毁
...
/// @param nFlag  0:状态改变; 1:新模板实例; 2:旧模板复用 
#define  XE_TREE_TEMP_CREATE             121  //@别名  元素事件_列表树模板创建
...
/// @param nFlag  0:状态改变(复用); 1:新模板实例; 2:旧模板复用
#define  XE_TREE_TEMP_CREATE_END         122  //@别名  元素事件_列表树模板创建完成
...
/// @param  nFlag   0:正常销毁;  1:移动到缓存(不会被销毁,临时缓存备用,当需要时被复用)
#define  XE_TREE_TEMP_DESTROY            123  //@别名  元素事件_列表树模板销毁
...
#define  XE_LISTVIEW_TEMP_CREATE           141   //@别名  元素事件_列表视图模板创建
...
#define  XE_LISTVIEW_TEMP_CREATE_END           142  //@别名  元素事件_列表视图模板创建完成
...
#define  XE_LISTVIEW_TEMP_DESTROY           143  //@别名  元素事件_列表视图模板销毁
...
#define  XE_EDIT_SWAPROW     186   //@别名  元素事件_交换行
...
#define  XE_DATETIME_POPUP_MONTHCAL     242   //@别名  元素事件_日期时间弹出月历
...
#define  XE_DATETIME_EXIT_MONTHCAL      243   //@别名  元素事件_日期时间退出月历

/// @brief  文件拖放事件, 需先启用:XWnd_EnableDragFiles()
/// @code   int CALLBACK OnDropFiles(HDROP hDropInfo, BOOL *pbHandled) @endcode
#define  XE_DROPFILES                 250  //@别名  元素事件_文件拖入
...
///@{
enum   menu_item_flag_  //@别名  弹出菜单项标识
{
	//@别名  正常
...
///@{
enum  menu_popup_position_  //@别名  弹出菜单方向
{
	//@别名  左上角
...
XC_API void WINAPI XFrameWnd_SetLayoutMargin(HWINDOW hWindow, int left, int top, int right, int bottom); //设置框架窗口布局区域外间距
...
XC_API void WINAPI XC_EnableAutoRedrawUI(BOOL bEnable); //启用自动重绘UI, 默认关闭
